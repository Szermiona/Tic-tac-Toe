...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
        boolean win = false;
        if (grid[0][0] == 'x' && grid[0][0] == grid[1][0] && grid[1][0] == grid[2][0]) {
            result = "x wins";
            win = true;
            ...
            result = "o wins";
            win = true;
        } else if (grid[0][0] == 'x' && grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2]) {
            result = "x wins";
            win = true;
            ...
            result = "o wins";
            win = true;
        } else if (grid[2][0] == grid[1][1] && grid[1][1] == grid[0][2] && grid[2][0] == 'x') {
            result = "x wins";
            win = true;
        } else if (grid[2][0] == grid[1][1] && grid[1][1] == grid[0][2] && grid[2][0] == 'o') {
            result = "o wins";
            win = true;
        } else if (freeSpots == 0 && !win) {
            result = "Tie";
        }
        return result;
    }
